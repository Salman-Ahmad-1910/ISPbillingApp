...
type Invoice struct {
	...
	PaidAmount      float64   `gorm:"type:decimal(10,2);default:0" json:"paidAmount"`
...
// BillRecord stores individual bill entries created by the Bill Creator
type BillRecord struct {
	TenantModel
	ConnectionID    uuid.UUID `gorm:"type:uuid;not null;index" json:"connectionId"`
	ConnectionName  string    `gorm:"type:varchar(255)" json:"connectionName"`
	ConnectionType  string    `gorm:"type:varchar(20);not null" json:"connectionType"`
