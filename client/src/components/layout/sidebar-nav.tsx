...
const navItems: NavItemGroup[] = [
  ...
  },
  {
    title: 'Inventory',
    items: [
      { title: 'Brand', href: '/inventory/brands', icon: Tag, allowedRoles: ['admin', 'manager'] },
      ...
      { title: 'Product', href: '/inventory/products', icon: Box, allowedRoles: ['admin', 'manager'] },
      { title: 'Vendor', href: '/inventory/vendors', icon: Building2, allowedRoles: ['admin', 'manager', 'dealer', 'sub_dealer', 'staff'] },
  ...
  },
  {
    title: 'Complaints',
    items: [
      { title: 'Complaint Type', href: '/support/complaints/complaint-type', icon: Tag, allowedRoles: ['admin', 'manager', 'dealer', 'sub_dealer', 'staff', 'recovery_officer'] },
      { title: 'Subject Type', href: '/support/complaints/subject-type', icon: BookOpen, allowedRoles: ['admin', 'manager', 'dealer', 'sub_dealer', 'staff', 'recovery_officer'] },
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Staff Salary', href: '/hr/salary', icon: Wallet, allowedRoles: ['admin', 'manager'] },
      { title: 'Staff Attendance', href: '/hr/attendance-day', icon: CalendarDays, allowedRoles: ['admin', 'manager'] },
      { title: 'Attendance Report', href: '/hr/attendance-subscriber', icon: Fingerprint, allowedRoles: ['admin', 'manager'] },
  ...
  },
  {
    ...
    items: [
      ...
      { title: 'Allocated Defaulters', href: '/subscriber-reports/allocated-defaulters', icon: TriangleAlert, allowedRoles: ['admin', 'manager', 'dealer', 'sub_dealer', 'staff', 'recovery_officer'] },
      ...
      { title: 'Allocated Collections', href: '/subscriber-reports/allocated-collections', icon: Handshake, allowedRoles: ['admin', 'manager', 'dealer', 'sub_dealer', 'staff', 'recovery_officer'] },
      { title: 'Month Wise Collection Monthly', href: '/subscriber-reports/monthwise-collection-monthly', icon: BarChartBig, allowedRoles: ['admin', 'manager', 'dealer', 'sub_dealer', 'staff', 'recovery_officer'] },
