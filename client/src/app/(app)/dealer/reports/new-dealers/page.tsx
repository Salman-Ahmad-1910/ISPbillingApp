...
import { CalendarIcon, Download, Printer, UserPlus, Loader2 } from 'lucide-react';
        ...
        <div className="group rounded-xl border bg-card p-4 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold mt-1">{totalDealers}</p>
            </div>
        ...
        <div className="group rounded-xl border bg-card p-4 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold mt-1 text-green-600">{filteredData.filter((d) => d.isActive).length}</p>
            </div>
