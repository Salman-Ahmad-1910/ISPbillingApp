  ...
  return (
    <div className="flex flex-col gap-6 p-6">
      ...
      <div className="flex items-center gap-3 no-print">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight bg-gradient-to-r from-red-600 to-rose-600 bg-clip-text text-transparent">Deactivate User Reports</h1>
          <p className="text-sm text-muted-foreground">View deactivated user accounts and their details</p>
        </div>
      </div>
      <div className="h-px bg-gradient-to-r from-red-500/30 via-rose-500/30 to-transparent" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <div className="group rounded-xl border bg-card p-4 transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg">
                <div className="flex items-center justify-between">
                  ...
                  <UserX className="h-4 w-4 text-muted-foreground transition-all duration-300 group-hover:scale-110" />
                </div>
