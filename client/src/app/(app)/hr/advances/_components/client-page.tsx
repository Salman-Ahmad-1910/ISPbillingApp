            ...
            <div className="p-6">
                <div className="flex items-center justify-between mb-4">
                    ...
                    <Dialog open={isFormOpen} onOpenChange={setIsFormOpen}>
                        <DialogTrigger asChild>
                            <Button onClick={() => setSelectedAdvance(null)}>
                        ...
                        <DialogContent>
                            <DialogHeader>
                                <DialogTitle>{selectedAdvance ? 'Edit' : 'Issue'} Advance/Loan</DialogTitle>
                            </DialogHeader>
                            <AdvanceLoanForm
                ...
                <div className="flex items-center justify-between mt-4">
                    <div className="text-sm text-muted-foreground">
                        Showing {((currentPage - 1) * pageSize) + 1} to {Math.min(currentPage * pageSize, filteredData.length)} of {filteredData.length} advances/loans
                    </div>
