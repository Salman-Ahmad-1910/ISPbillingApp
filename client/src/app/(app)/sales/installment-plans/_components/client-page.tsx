...
export function ClientPage({ data, products }: ClientPageProps) {
    ...
    const handleSave = async (formData: PlanFormValues) => {
        ...
        try {
            ...
            queryClient.invalidateQueries({ queryKey: ['sales/installment-plans', companyId] });
            setIsFormOpen(false);
    ...
    const handleDelete = async () => {
        if (selectedPlan) {
            try {
                await api.delete(`/sales/installment-plans/${selectedPlan.id}?companyId=${companyId}`);
    ...
    const openDeleteDialog = (plan: InstallmentPlan) => {
        setSelectedPlan(plan);
                ...
                <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Dialog open={isFormOpen} onOpenChange={setIsFormOpen}>
                            ...
                            <DialogContent>
                                <DialogHeader>
                                    <DialogTitle>{selectedPlan ? 'Edit' : 'Create'} Installment Plan</DialogTitle>
                                </DialogHeader>
                                <InstallmentPlanForm
                                    plan={selectedPlan}
                                    products={products}
