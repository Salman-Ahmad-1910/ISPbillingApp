...
import { CalendarIcon, Download, Search, Filter, RefreshCw, User, Activity, AlertTriangle, CheckCircle } from 'lucide-react';
...
export default function LogsPage() {
  ...
  const fetchLogs = async () => {
    ...
    try {
      ...
      // Safety check: handle both array and object cases for response.data.data
      let logsArray = [];
      ...
      {/* {summary && (
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-green-600">{summary?.successCount?.toLocaleString()}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-yellow-600">{summary?.warningCount?.toLocaleString()}</div>
