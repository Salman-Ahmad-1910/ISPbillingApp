              ...
              <TableRow>
                ...
                >
                  <div className="flex flex-col items-center justify-center gap-3">
                    ...
                    <p className="text-sm font-medium text-muted-foreground">No splitters found</p>
                    <p className="text-xs text-muted-foreground/60">Get started by adding a new splitter.</p>
                  </div>
                </TableCell>
              </TableRow>
            )}
