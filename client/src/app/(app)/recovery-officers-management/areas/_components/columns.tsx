...
export const getColumns = ({ recoveryOfficers, onEdit, onDelete }: ColumnsProps): ColumnDef<Area>[] => [
  {
    accessorKey: 'city',
    header: 'City',
  },
        ...
        <div className="text-right">
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem onClick={() => onEdit(area)} className="data-[highlighted]:text-emerald-600">
                Edit Area
              </DropdownMenuItem>
              <DropdownMenuSeparator />
              <DropdownMenuItem className="text-destructive data-[highlighted]:text-red-600" onClick={() => onDelete(area)}>
                Delete Area
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
