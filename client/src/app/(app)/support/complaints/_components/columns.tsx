        ...
        <div className="text-right">
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuItem onClick={() => onEdit(complaint)} className="data-[highlighted]:text-emerald-600">Edit Complaint</DropdownMenuItem>
              <DropdownMenuSeparator />
              <DropdownMenuItem className="text-destructive data-[highlighted]:text-red-600" onClick={() => onDelete(complaint)}>
                Delete Complaint
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
