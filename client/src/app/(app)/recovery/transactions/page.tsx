...
import { Loader2, FileClock, ArrowLeftRight, DollarSign } from 'lucide-react';
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Recovery Transactions</h1>
          <p className="text-sm text-muted-foreground">Manage your financial transactions like cash floats and expenses.</p>
        </div>
      </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-2xl font-bold text-emerald-600 dark:text-emerald-400">
                PKR {transactions.length > 0 ? Math.round(totalAmount / transactions.length).toLocaleString() : 0}
              </p>
            </div>
          </div>
        </div>
