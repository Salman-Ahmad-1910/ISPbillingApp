                ...
                <div className="flex items-center justify-between mb-4">
                    ...
                    <Dialog open={isFormOpen} onOpenChange={setIsFormOpen}>
                        <DialogTrigger asChild>
                            <Button onClick={() => setSelectedTransaction(null)} className="bg-gradient-to-r from-emerald-500 to-green-600 text-white shadow-sm hover:from-emerald-600 hover:to-green-700">
                        ...
                        <DialogContent className="max-h-[85vh] overflow-y-auto rounded-xl shadow-lg">
                            <DialogHeader>
                                <DialogTitle className="flex items-center gap-2">
                                    ...
                                    <span>{selectedTransaction ? 'Edit' : 'Add'} Transaction</span>
                                </DialogTitle>
                            </DialogHeader>
